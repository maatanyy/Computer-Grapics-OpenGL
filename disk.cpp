...
/* 기능 :  Display List를 사용하여 disk를 구현하였습니다              */
...
void MyCreateList() {
	...
	gluDisk(qobj, 0.5, 0.7, 40, 3);    //안쪽 반지름 0.5 바깥쪽 반지금 0.7 z축을 중심으로 하는 Subdivisions의 개수 40개, disk가 세분화되는 동심원의 개수 3개로 설정->도넛모양으로나옴
