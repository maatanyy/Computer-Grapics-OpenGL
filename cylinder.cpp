...
/* 기능 :  Display List를 사용하여 Cylinder를 구현하였습니다              */
//GLU_FILL 을 사용하였고 조명을 설정하고 Texture 좌표는 사용하지않았습니다//
//       Lookat 과 Rotate 중 고민하다 Rotate 를 사용하였습니다        //
//                                                                   //
/********************************************************************/
#include <GL/glut.h>
...
void MyCreateList() {
	...
	glRotatef(70, 1.5, 0, 0);    //rotate 를 사용하여 돌려줌
	gluCylinder(qobj, 0.5, 0.7, 0.7, 20, 8);  //아래반지름 0.5 위반지름 0.7 높이0.7 회전개수 20 subdivision 개수 8로 설정
