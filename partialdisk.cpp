...
/* 기능 :  Display List를 사용하여 partialdisk를 구현하였습니다              */
//GLU_LINE 을 사용하였고 조명을 설정하고 Texture 좌표는 사용하지않았습니다//
//                     오른쪽 반원 모양으로 나오게하였습니다          //
//                      거미줄 처럼 나오게 하였습니다                 //
/********************************************************************/
#include <GL/glut.h>
...
void MyCreateList() {
	...
	gluQuadricDrawStyle(qobj, GLU_LINE); // Quadric을 위해 원하는 Draw Style 지정 -> GLU_LINE로 설정
	...
	gluPartialDisk(qobj, 0.3, 0.8, 26, 13, 0,180);  // 안쪽 반지금 0.3 바깥쪽 반지름 0.8 z축 주변의 subdivision 26 동심원개수 13 시작되는 각도 0 생성되는 각도 180도
